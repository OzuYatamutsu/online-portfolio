...
This is done automatically on `git push` via the [Build and Deploy](https://github.com/OzuYatamutsu/online-portfolio/actions/workflows/build-and-deploy.yaml) CI/CD job.
...
## Deployment
Merges to `main` automatically trigger a build and deploy of all content in the repository. See the [Actions](https://github.com/OzuYatamutsu/online-portfolio/actions) tab to see it in action!
